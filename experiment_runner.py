...
def main():
    ...
    """
    experiments = [
        FedExperiment.from_params("FedSeq - runs comparison EMNIST - Greedy classifierLast C:0.02",
                                  "",
                                Param("algo", "fedseq"),
                                Param("device", "cuda:0"),
                                Param("n_round", 1500),
                                ...
                                MultiParam.key("algo.params.clustering.measure",
                                        ["cosine", "wasserstein"]),
                                Param("dataset", "emnist_niid"),
                                Param("algo.params.common.C", 0.02),
                                MultiParam.dict("algo.params.clustering",
                                                  {"min_examples": [1030, 2060, 4120],
                                                   "max_clients": [6, 11, 21]}),
                                runner_options={"--time": "10:30:00"}
        ...
        FedExperiment.from_params("FedSeq - runs comparison EMNIST - Greedy classifierLast C:0.05",
                                  "",
                                Param("algo", "fedseq"),
                                Param("device", "cuda:0"),
                                Param("n_round", 1500),
                                ...
                                MultiParam.key("algo.params.clustering.measure",
                                    ["cosine", "wasserstein"]),
                                Param("dataset", "emnist_niid"),
                                Param("algo.params.common.C", 0.05),
                                MultiParam.dict("algo.params.clustering",
                                                {"min_examples": [1030, 2060, 4120],
                                                "max_clients": [6, 11, 21]}),
                                runner_options={"--time": "13:00:00"}
        ...
        FedExperiment.from_params("FedSeq - runs comparison EMNIST - KMeans C:0.02",
                                  "",
                                Param("algo", "fedseq"),
                                Param("device", "cuda:0"),
                                Param("n_round", 1500),
        ...
        FedExperiment.from_params("FedSeq - runs comparison EMNIST - KMeans C:0.05",
                                  "",
                                Param("algo", "fedseq"),
                                Param("device", "cuda:0"),
                                Param("n_round", 1500),
        ...
        FedExperiment.from_params("FedSeq - runs comparison EMNIST - Greedy confidence C:0.02",
                                  "",
                                Param("algo", "fedseq"),
                                Param("device", "cuda:0"),
                                Param("n_round", 1500),
        ...
        FedExperiment.from_params("FedSeq - runs comparison EMNIST - Greedy confidence C:0.05",
                                  "",
                                Param("algo", "fedseq"),
                                Param("device", "cuda:0"),
                                Param("n_round", 1500),
        ...
        FedExperiment.from_params("FedSeq - runs comparison EMNIST - Random C 0.02",
                                  "",
                                Param("algo", "fedseq"),
                                Param("device", "cuda:0"),
                                Param("n_round", 1500),
        ...
        FedExperiment.from_params("FedSeq - runs comparison EMNIST - Random C 0.05",
                                  "",
                                Param("algo", "fedseq"),
                                Param("device", "cuda:0"),
                                Param("n_round", 1500),
        ...
        FedExperiment.from_params("FedAvg - runs EMNIST - C 0.02",
                            "",
                            Param("algo", "fedavg"),
                            Param("device", "cuda:0"),
                            Param("model","emnist"),
        ...
        FedExperiment.from_params("FedAvg - runs EMNIST - C 0.05",
                            "",
                            Param("algo", "fedavg"),
                            Param("device", "cuda:0"),
                            Param("model","emnist"),
