...
class Centralized(Algo):
    def __init__(self, model_info, params, device: str, dataset,
        ...
        training_set = dataset_class(train_img, train_label, dataset_num_classes, device = device)
        test_set = dataset_class(test_img, test_label, dataset_num_classes, device = device, train=False)
